...
from src.wrapper.GymWrapper_rgb import GymWrapper_rgb
...
if __name__ == '__main__':
    ...
    #tb_log_folder = file_handling["tb_log_folder"]  #########CHANGE
    #tb_log_name = file_handling["tb_log_name"]           #########CHANGE
    ...
    if training:
        ...
        env_gym = GymWrapper_rgb(suite.make(env_id, **env_options))
